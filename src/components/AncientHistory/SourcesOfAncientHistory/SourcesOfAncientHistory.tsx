    ...
    <Container>
      ...
      <div className="ancient-content">
        ...
        <h4>
          ...
          India. Acc to scholar, the literal meaning of Tripataka is 'basket'.
          The no of Tripatakas is 3: Sutpitaka(S), vinaypitaka(V), abhidhamma
          pitaka(A). S conatinss a collection of religious thoughts and
          teachings of Lord Budha. It is considered to be the largest and the
          best among Pitakas. In V, rules related to the discipline of the Math
          residents are gn. Budhist beliefs have been philosophically
          interpreted in A. Apart from pitaka, milindapanho, deepavansh and
          mahavansh are also budhist literature. Budist literature has been
          composed mainly in pali language. In Jataka, there is a description of
          the story of lord budhas previous birth
        </h4>
        <h4>
          Jainism: The early history of Jainism is known from the Kalpasutra.
          Jain literature is called Agam. The language of this literature is
          Sanskrit and Pakrit. It is believed that these Agama texts have been
          composed after the death of Lord Mahavir swami.
        </h4>
        <h4>
        ...
        <h4>
          Kalhana: The 1st attempt to write historical events in sanskrit
          literature was done by kalhan. The book rajatarangini was composed by
          Kalhan, which is related to the history of Kashmir.{" "}
        </h4>
        <h4>
          Panini: is the author of 1st book of Sanskrit language grammar -
          Ashtadhyayi. In this book, info abt the history of Maurya and the
          political age of Mauryan is received
        </h4>
        <h4>
          Katyayan: The gargi-samhita was written by Katyayan, an astrological
          treastise, yet it mentions the Yavana invasion of India.{" "}
        </h4>
        <h4>
        ...
        <h4>
          ...
          Historica, he has described the relation of Indo-Persia of 5th BC.
        </h4>
        <h4>
          2. Megasthene: It was the ambassador of Seleucus Nicator, who came to
          court of Chandragupta maurya. Is has written abt the Maurya era
          society and culture in the book Indika.
        </h4>
        <h4>
        ...
        <h4>
          4. Ptolemy: It wrote a book called Geography of India int the 2nd
          centuary.
        </h4>
        <h4>
          Pliny: It wrote a book called Natural History in the 1st century
        </h4>
        <h4>
          Hiuen Tsang: This chineese traveler came to India during the reign of
          Harshvardana. Its travelogue is famous by the name of si-u-ki, which
          gives details of 138 countries. It departed from China fro India and
          first reachhed the iNDIAN STATE OF kApisha. He came to study at
          Nalanda university in Nalanda district Bihar and collected Buddist
          texts from India.{" "}
        </h4>
        <h1>
        ...
        <h4>
          Alberuni: He came to India with the Arabic traveller Mahmud Ghaznavi.
          The name of this book written in arabic is Kitab-ul-Hind or
          Tehkiq-e-Hind(Invention of India)
        </h4>
        <h4>
          Ibn Battula: The travelogue written by him in arabic lanaguage is
          called Rihrla. On reaching Delhi, Muhammad bin Tughluq appointed it as
          the Qazi or judge of India.
        </h4>
        <h4>
          Taranath: It was a tibetian writter. He composed a book called Kangyur
          and Tangyur
        </h4>
        <h4>
