  ...
  return (
    <div>
      ...
      <div className="ancient-container">
        ...
        the narmada valley. <h4>Paleolithic/Ice age</h4>
        ...
        Hunting, herders ie domestication - first animal is dog.- Stone tools
        were microliths - There was a change in the temperature. The heat rose.
        Due to increasing heat, crops like barley, wheat, paddy, started
        ...
        have been found in west, central india, mysore. People in this
        mesolithic age were maily cattle herders. - Paisra(bihar),
        langnaj(gujrat), baghor II - characteristics: 1. During this age, man
        had invented the samll tool like spearheads, arrow heads, etc 2. The
        main mesolithic age had started taming the dogs for the hunting purpose.
        3. The man of this age was still a food collector and not a food
        producer
        <h4>Neolithic/new stone age</h4>
        Agriculture, domesticated, burials, tamed, storehouse, village, housing,
        handycrafts, loom In this era, people became producer of food, ie they
        had a good knowledge of the agricultural method. This is the 3rd and
        final episode of stone age. 4000-2500bc. The brain of man had become
        more developed. Evidence found in south of Godavari river, south india.
        In this era, indian humans established settlements near granite hills or
